...
// Sample conversation data - from customer perspective
const conversations = [
  {
    id: '1',
    name: 'Maya Johnson',
    lastMessage: 'Perfect! See you tomorrow at 2 PM for your box braids.',
    time: '10:23 AM',
    unread: 1,
  ...
  },
  {
    id: '2',
    name: 'Aisha Thompson',
    lastMessage: 'Yes, I can do next Friday at 11 AM. Would that work?',
    time: 'Yesterday',
    unread: 0,
  ...
  },
  {
    id: '3',
    name: 'Zara Williams',
    lastMessage: 'Thank you for choosing me! Your braids look amazing 💕',
    time: 'Jul 24',
    unread: 0,
  ...
  },
  {
    id: '4',
    name: 'Keisha Davis',
    lastMessage: 'I have availability this Saturday at 1 PM if that works.',
    time: 'Jul 23',
    unread: 2,
    avatar: null,
  },
  {
    id: '5',
    name: 'Tiana Brown',
    lastMessage: 'Those reference photos look great! I can definitely do that style.',
    time: 'Jul 22',
    unread: 0,
    avatar: null,
  },
      ...
      <View style={[styles.header, { paddingTop: Math.max(insets.top, 20) }]}>
        <View style={styles.headerTitleContainer}>
          <View style={styles.profileInitialCircle}>
            <Text style={styles.profileInitial}>TC</Text>
          </View>
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyStateDescription}>
            {searchQuery 
              ...
              : 'When you message stylists or they message you, conversations will appear here'
            }
          </Text>
        </View>
      )}
